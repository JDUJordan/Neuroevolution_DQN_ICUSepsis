...
from src.utils.models import linear_schedule
from src.utils.models import DeepQNetwork as QNetwork


# Add these functions before the run_dqn function
    ...
    while episode_number < args.max_episodes:
        ...
        if terminated:
            ...
            if episode_number >= args.max_episodes - 1:
                final_model_path = os.path.join(model_dir, f'dqn_final_seed_{args.seed}.pt')
